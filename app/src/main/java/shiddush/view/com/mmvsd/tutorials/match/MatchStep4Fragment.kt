...
class MatchStep4Fragment : Fragment() {
    lateinit var nextClickListener: NextClickListener
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {

        return inflater.inflate(R.layout.fragment_match_step_4, container, false)
    }
    ...
    private fun inIt() {
        textView.setText(R.string.highlight_match_step_4)
