...
class ReviewStep6Fragment : Fragment() {
    lateinit var nextClickListener: NextClickListener
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {

        return inflater.inflate(R.layout.fragment_review_step_6, container, false)
    }
    ...
    private fun inIt() {
        textView.setText(R.string.highlight_review_step_6)
        btn_next.setOnClickListener {
            nextClickListener.onNextClick(6)
        }
    }
