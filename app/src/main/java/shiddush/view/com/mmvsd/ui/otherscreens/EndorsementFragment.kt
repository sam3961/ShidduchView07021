...
import shiddush.view.com.mmvsd.databinding.FragmentEndorsementBinding
...
class EndorsementFragment : Fragment() {
    ...
    lateinit var binding: FragmentEndorsementBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {

        // Inflate the fragment_intro_notes for this fragment
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_endorsement, container, false)
    ...
    private fun setTextSizes() {
        ...
        binding.webSite.setTextSize(TypedValue.COMPLEX_UNIT_DIP, size15)
        ...
        binding.endrosmentLayout.background = ContextCompat.getDrawable(activity!!, bgImage)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (SocketCommunication.isSocketConnected()) {
            SocketCommunication.emitInScreenActivity(ENDORSEMENT_SCREEN)
        }
